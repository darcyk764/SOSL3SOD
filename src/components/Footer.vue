    ...
    <footer class="bg-green-800 text-white px-8 py-10 mt-10  ">
        <div class="flex flex-wrap justify-between gap-8">
         ...
         <div>
            ...
            <ul class="text-sm space-y-2">
                <li class="text-green-300">201 Main Street, Kigali</li>
                <li class="text-green-300">Phone: +250 788 536 767</li>
                <li class="text-green-300">Email: hirwadarcy15@gmail.com</li>
            </ul>
                 </div>
        </div>   
        <!--place for copyright-->
